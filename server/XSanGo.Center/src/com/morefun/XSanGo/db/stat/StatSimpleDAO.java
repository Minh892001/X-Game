 ...
 * 
 */
public class StatSimpleDAO extends HibernateDaoSupport {

	private static final Logger log = LoggerFactory.getLogger(StatSimpleDAO.class);
	...
	public static StatSimpleDAO getForStat(ApplicationContext ctx) {
		return (StatSimpleDAO) ctx.getBean("StatSimpleDAO");
	}
