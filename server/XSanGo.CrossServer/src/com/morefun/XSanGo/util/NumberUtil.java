...
public class NumberUtil {
	 ...
	 * @return
	 */
	public static boolean isBetweenIncludeLowerNoUpper(int value, int lower,
			int upper) {
	...
	public static long parseColorRGBAFromHtml(String htmlColor) {
		...
		long r = Long.valueOf(htmlColor.substring(startIndex, startIndex + 2),
				16);
		long g = Long.valueOf(
				htmlColor.substring(startIndex + 2, startIndex + 4), 16);
		long b = Long.valueOf(
				htmlColor.substring(startIndex + 4, startIndex + 6), 16);
		long a = 255;
