...
public abstract class AMI_AttackCastle_beginAttackCastle extends Callback_AttackCastle_beginAttackCastle
{
    public abstract void ice_response(CastleNodeView __ret);
    ...
    public final void response(CastleNodeView __ret)
    {
        ice_response(__ret);
    }
