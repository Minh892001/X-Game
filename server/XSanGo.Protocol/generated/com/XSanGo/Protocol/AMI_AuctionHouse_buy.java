...
public abstract class AMI_AuctionHouse_buy extends Callback_AuctionHouse_buy
{
    public abstract void ice_response(AuctionBuyResView __ret);
    ...
    public final void response(AuctionBuyResView __ret)
    {
        ice_response(__ret);
    }
