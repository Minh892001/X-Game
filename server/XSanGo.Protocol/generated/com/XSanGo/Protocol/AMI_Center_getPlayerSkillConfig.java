...
public abstract class AMI_Center_getPlayerSkillConfig extends Callback_Center_getPlayerSkillConfig
{
    public abstract void ice_response(IntString[] __ret);
    ...
    public final void response(IntString[] __ret)
    {
        ice_response(__ret);
    }
