...
public abstract class AMI_Center_ping extends Callback_Center_ping
{
    public abstract void ice_response(ServerDetail __ret);
    ...
    public final void response(ServerDetail __ret)
    {
        ice_response(__ret);
    }
