...
public abstract class AMI_Copy_beginChallenge extends Callback_Copy_beginChallenge
{
    public abstract void ice_response(CopyChallengeResultView __ret);
    ...
    public final void response(CopyChallengeResultView __ret)
    {
        ice_response(__ret);
    }
