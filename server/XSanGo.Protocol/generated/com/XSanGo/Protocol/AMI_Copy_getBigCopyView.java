...
public abstract class AMI_Copy_getBigCopyView extends Callback_Copy_getBigCopyView
{
    public abstract void ice_response(BigCopyView __ret);
    ...
    public final void response(BigCopyView __ret)
    {
        ice_response(__ret);
    }
