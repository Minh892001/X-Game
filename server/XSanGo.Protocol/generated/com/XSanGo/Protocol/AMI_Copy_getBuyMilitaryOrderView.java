...
public abstract class AMI_Copy_getBuyMilitaryOrderView extends Callback_Copy_getBuyMilitaryOrderView
{
    public abstract void ice_response(BuyMilitaryOrderView __ret);
    ...
    public final void response(BuyMilitaryOrderView __ret)
    {
        ice_response(__ret);
    }
