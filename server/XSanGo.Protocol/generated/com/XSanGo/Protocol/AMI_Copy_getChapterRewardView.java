...
public abstract class AMI_Copy_getChapterRewardView extends Callback_Copy_getChapterRewardView
{
    public abstract void ice_response(ChapterRewardView __ret);
    ...
    public final void response(ChapterRewardView __ret)
    {
        ice_response(__ret);
    }
