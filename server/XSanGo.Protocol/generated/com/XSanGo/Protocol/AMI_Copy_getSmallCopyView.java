...
public abstract class AMI_Copy_getSmallCopyView extends Callback_Copy_getSmallCopyView
{
    public abstract void ice_response(SmallCopyView __ret);
    ...
    public final void response(SmallCopyView __ret)
    {
        ice_response(__ret);
    }
