...
public abstract class AMI_Copy_getSmallCopyViewWithWarmup extends Callback_Copy_getSmallCopyViewWithWarmup
{
    public abstract void ice_response(SmallCopyViewWithWarmup __ret);
    ...
    public final void response(SmallCopyViewWithWarmup __ret)
    {
        ice_response(__ret);
    }
