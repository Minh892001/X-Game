...
public abstract class AMI_Equip_levelupAll extends Callback_Equip_levelupAll
{
    public abstract void ice_response(EquipLevelEntity[] __ret);
    ...
    public final void response(EquipLevelEntity[] __ret)
    {
        ice_response(__ret);
    }
