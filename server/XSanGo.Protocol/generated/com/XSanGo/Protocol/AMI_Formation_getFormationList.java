...
public abstract class AMI_Formation_getFormationList extends Callback_Formation_getFormationList
{
    public abstract void ice_response(FormationView[] __ret);
    ...
    public final void response(FormationView[] __ret)
    {
        ice_response(__ret);
    }
