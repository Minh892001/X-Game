...
public abstract class AMI_GameSession_getRole extends Callback_GameSession_getRole
{
    public abstract void ice_response(RolePrx __ret);
    ...
    public final void response(RolePrx __ret)
    {
        ice_response(__ret);
    }
