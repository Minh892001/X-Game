...
public abstract class AMI_Gm_getCurrentWhiteList extends Callback_Gm_getCurrentWhiteList
{
    public abstract void ice_response(WhiteList[] __ret);
    ...
    public final void response(WhiteList[] __ret)
    {
        ice_response(__ret);
    }
