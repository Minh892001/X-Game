...
public abstract class AMI_Gm_getGuideConfig extends Callback_Gm_getGuideConfig
{
    public abstract void ice_response(GuideConfig __ret);
    ...
    public final void response(GuideConfig __ret)
    {
        ice_response(__ret);
    }
