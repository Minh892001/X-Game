...
public abstract class AMI_Gm_ping extends Callback_Gm_ping
{
    public abstract void ice_response(GameServerView[] __ret);
    ...
    public final void response(GameServerView[] __ret)
    {
        ice_response(__ret);
    }
