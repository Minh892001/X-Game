...
public abstract class AMI_Hero_getHeroSkillView extends Callback_Hero_getHeroSkillView
{
    public abstract void ice_response(HeroSkillPointView __ret);
    ...
    public final void response(HeroSkillPointView __ret)
    {
        ice_response(__ret);
    }
