...
public abstract class AMI_Hero_summonHero extends Callback_Hero_summonHero
{
    public abstract void ice_response(HeroView __ret);
    ...
    public final void response(HeroView __ret)
    {
        ice_response(__ret);
    }
