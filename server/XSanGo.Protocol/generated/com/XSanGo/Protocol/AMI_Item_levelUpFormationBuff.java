...
public abstract class AMI_Item_levelUpFormationBuff extends Callback_Item_levelUpFormationBuff
{
    public abstract void ice_response(ItemView __ret);
    ...
    public final void response(ItemView __ret)
    {
        ice_response(__ret);
    }
