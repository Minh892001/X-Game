...
public abstract class AMI_Ladder_beginFight extends Callback_Ladder_beginFight
{
    public abstract void ice_response(LadderPvpView __ret);
    ...
    public final void response(LadderPvpView __ret)
    {
        ice_response(__ret);
    }
