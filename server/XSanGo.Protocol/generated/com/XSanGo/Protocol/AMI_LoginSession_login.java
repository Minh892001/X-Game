...
public abstract class AMI_LoginSession_login extends Callback_LoginSession_login
{
    public abstract void ice_response(ServerList __ret);
    ...
    public final void response(ServerList __ret)
    {
        ice_response(__ret);
    }
