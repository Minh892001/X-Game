...
public abstract class AMI_Role_getActivityAnnounce extends Callback_Role_getActivityAnnounce
{
    public abstract void ice_response(ActivityAnnounceView[] __ret);
    ...
    public final void response(ActivityAnnounceView[] __ret)
    {
        ice_response(__ret);
    }
