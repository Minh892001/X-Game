...
public abstract class AMI_Role_getDuelStrategyConfig extends Callback_Role_getDuelStrategyConfig
{
    public abstract void ice_response(DuelSkillTemplateView[] __ret);
    ...
    public final void response(DuelSkillTemplateView[] __ret)
    {
        ice_response(__ret);
    }
