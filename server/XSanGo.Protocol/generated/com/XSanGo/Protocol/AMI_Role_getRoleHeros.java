...
public abstract class AMI_Role_getRoleHeros extends Callback_Role_getRoleHeros
{
    public abstract void ice_response(OthersHeroView __ret);
    ...
    public final void response(OthersHeroView __ret)
    {
        ice_response(__ret);
    }
