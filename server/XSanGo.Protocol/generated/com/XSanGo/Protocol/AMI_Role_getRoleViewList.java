...
public abstract class AMI_Role_getRoleViewList extends Callback_Role_getRoleViewList
{
    public abstract void ice_response(RoleView[] __ret);
    ...
    public final void response(RoleView[] __ret)
    {
        ice_response(__ret);
    }
