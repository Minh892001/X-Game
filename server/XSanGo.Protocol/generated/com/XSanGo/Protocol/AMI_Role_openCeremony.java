...
public abstract class AMI_Role_openCeremony extends Callback_Role_openCeremony
{
    public abstract void ice_response(SceneDuelView[] __ret);
    ...
    public final void response(SceneDuelView[] __ret)
    {
        ice_response(__ret);
    }
