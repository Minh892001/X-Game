...
public abstract class AMI_Tournament_beginFightWith extends Callback_Tournament_beginFightWith
{
    public abstract void ice_response(FightFormations __ret);
    ...
    public final void response(FightFormations __ret)
    {
        ice_response(__ret);
    }
