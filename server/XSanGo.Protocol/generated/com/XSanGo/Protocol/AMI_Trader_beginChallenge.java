...
public abstract class AMI_Trader_beginChallenge extends Callback_Trader_beginChallenge
{
    public abstract void ice_response(DuelReportView __ret);
    ...
    public final void response(DuelReportView __ret)
    {
        ice_response(__ret);
    }
