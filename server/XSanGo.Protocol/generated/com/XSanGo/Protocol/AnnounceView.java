...
public class AnnounceView implements java.lang.Cloneable, java.io.Serializable
{
    public String title;
    ...
    public AnnounceView(String title, String content)
    {
        this.title = title;
    ...
    equals(java.lang.Object rhs)
    {
        ...
        AnnounceView _r = null;
        if(rhs instanceof AnnounceView)
        {
            _r = (AnnounceView)rhs;
        }
    ...
    {
        int __h = 5381;
        __h = IceInternal.HashUtil.hashAdd(__h, "::com::XSanGo::Protocol::AnnounceView");
    ...
    public static final long serialVersionUID = 1295800647L;
}
