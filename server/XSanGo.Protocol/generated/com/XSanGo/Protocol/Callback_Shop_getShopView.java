...
public abstract class Callback_Shop_getShopView extends Ice.TwowayCallback
{
    ...
    {
        ShopPrx __proxy = (ShopPrx)__result.getProxy();
        String __ret = null;
        try
        {
            __ret = __proxy.end_getShopView(__result);
        }
