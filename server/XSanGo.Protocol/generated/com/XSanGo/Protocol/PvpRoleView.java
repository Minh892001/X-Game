 ...
 * PVP角色数据
 **/
public class PvpRoleView implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public PvpRoleView(String roleId, String roleName, String headImg, int level, int vipLevel, int serverId, int sex, String factionName)
    {
        this.roleId = roleId;
    ...
    {
        int __h = 5381;
        __h = IceInternal.HashUtil.hashAdd(__h, "::com::XSanGo::Protocol::PvpRoleView");
    ...
    public static final long serialVersionUID = -45930712L;
}
