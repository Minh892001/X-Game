...
public class ShootScoreRankSub implements java.lang.Cloneable, java.io.Serializable
{
    public int rank;
    ...
    public ShootScoreRankSub()
    {
    }

    public ShootScoreRankSub(int rank, String roleId, String roleName, String factionName, int vip, int level, String icon, int score)
    {
        this.rank = rank;
        this.roleId = roleId;
    ...
    equals(java.lang.Object rhs)
    {
        ...
        ShootScoreRankSub _r = null;
        if(rhs instanceof ShootScoreRankSub)
        {
            _r = (ShootScoreRankSub)rhs;
        }
    ...
    {
        int __h = 5381;
        __h = IceInternal.HashUtil.hashAdd(__h, "::com::XSanGo::Protocol::ShootScoreRankSub");
    ...
    public static final long serialVersionUID = 142498492L;
}
