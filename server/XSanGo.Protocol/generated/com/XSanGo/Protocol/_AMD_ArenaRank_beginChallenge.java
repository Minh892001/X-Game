...
final class _AMD_ArenaRank_beginChallenge extends IceInternal.IncomingAsync implements AMD_ArenaRank_beginChallenge
{
    public _AMD_ArenaRank_beginChallenge(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(PvpOpponentFormationView __ret)
    {
