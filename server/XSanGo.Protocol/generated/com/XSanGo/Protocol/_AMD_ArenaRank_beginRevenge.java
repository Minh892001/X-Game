...
final class _AMD_ArenaRank_beginRevenge extends IceInternal.IncomingAsync implements AMD_ArenaRank_beginRevenge
{
    public _AMD_ArenaRank_beginRevenge(IceInternal.Incoming in)
    {
        super(in);
    }
