...
final class _AMD_ArenaRank_crossRevenge extends IceInternal.IncomingAsync implements AMD_ArenaRank_crossRevenge
{
    public _AMD_ArenaRank_crossRevenge(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(FightResultView __ret)
    {
