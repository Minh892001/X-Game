...
final class _AMD_ArenaRank_getCrossMovie extends IceInternal.IncomingAsync implements AMD_ArenaRank_getCrossMovie
{
    public _AMD_ArenaRank_getCrossMovie(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(FightMovieView[] __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                FightMovieViewSeqHelper.write(__os, __ret);
