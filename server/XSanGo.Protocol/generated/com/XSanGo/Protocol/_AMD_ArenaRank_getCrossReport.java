...
final class _AMD_ArenaRank_getCrossReport extends IceInternal.IncomingAsync implements AMD_ArenaRank_getCrossReport
{
    public _AMD_ArenaRank_getCrossReport(IceInternal.Incoming in)
    {
        super(in);
    }
