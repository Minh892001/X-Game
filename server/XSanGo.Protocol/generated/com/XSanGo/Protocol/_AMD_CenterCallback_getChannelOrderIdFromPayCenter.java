...
final class _AMD_CenterCallback_getChannelOrderIdFromPayCenter extends IceInternal.IncomingAsync implements AMD_CenterCallback_getChannelOrderIdFromPayCenter
{
    public _AMD_CenterCallback_getChannelOrderIdFromPayCenter(IceInternal.Incoming in)
    {
        super(in);
    }
