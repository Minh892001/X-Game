...
final class _AMD_Center_getFactionMemberList extends IceInternal.IncomingAsync implements AMD_Center_getFactionMemberList
{
    public _AMD_Center_getFactionMemberList(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(GmFactionMemberView[] __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                GmFactionMemberViewSeqHelper.write(__os, __ret);
