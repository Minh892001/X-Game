...
final class _AMD_Center_getPayLog extends IceInternal.IncomingAsync implements AMD_Center_getPayLog
{
    public _AMD_Center_getPayLog(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(GmPayView __ret)
    {
