...
final class _AMD_Center_getRankList extends IceInternal.IncomingAsync implements AMD_Center_getRankList
{
    public _AMD_Center_getRankList(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(GmRankView[] __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                GmRankViewSeqHelper.write(__os, __ret);
