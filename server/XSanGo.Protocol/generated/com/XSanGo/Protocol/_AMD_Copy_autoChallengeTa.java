...
final class _AMD_Copy_autoChallengeTa extends IceInternal.IncomingAsync implements AMD_Copy_autoChallengeTa
{
    public _AMD_Copy_autoChallengeTa(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(ChallengeTaAutoResult __ret)
    {
