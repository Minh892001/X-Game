...
final class _AMD_Copy_beginChallengeTa extends IceInternal.IncomingAsync implements AMD_Copy_beginChallengeTa
{
    public _AMD_Copy_beginChallengeTa(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(ChallengeTaView __ret)
    {
