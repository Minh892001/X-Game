...
final class _AMD_Copy_endChallenge extends IceInternal.IncomingAsync implements AMD_Copy_endChallenge
{
    public _AMD_Copy_endChallenge(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(EndChallengeResultView __ret)
    {
