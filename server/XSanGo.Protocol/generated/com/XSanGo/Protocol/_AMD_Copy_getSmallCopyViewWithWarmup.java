...
final class _AMD_Copy_getSmallCopyViewWithWarmup extends IceInternal.IncomingAsync implements AMD_Copy_getSmallCopyViewWithWarmup
{
    public _AMD_Copy_getSmallCopyViewWithWarmup(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(SmallCopyViewWithWarmup __ret)
    {
