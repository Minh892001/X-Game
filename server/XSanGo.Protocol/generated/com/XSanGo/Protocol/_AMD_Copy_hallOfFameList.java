...
final class _AMD_Copy_hallOfFameList extends IceInternal.IncomingAsync implements AMD_Copy_hallOfFameList
{
    public _AMD_Copy_hallOfFameList(IceInternal.Incoming in)
    {
        super(in);
    }
