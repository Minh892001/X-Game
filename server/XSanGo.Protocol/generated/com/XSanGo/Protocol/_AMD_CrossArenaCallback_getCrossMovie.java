...
final class _AMD_CrossArenaCallback_getCrossMovie extends IceInternal.IncomingAsync implements AMD_CrossArenaCallback_getCrossMovie
{
    public _AMD_CrossArenaCallback_getCrossMovie(IceInternal.Incoming in)
    {
        super(in);
    }
