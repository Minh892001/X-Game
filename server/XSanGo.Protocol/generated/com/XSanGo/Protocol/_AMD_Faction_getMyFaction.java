...
final class _AMD_Faction_getMyFaction extends IceInternal.IncomingAsync implements AMD_Faction_getMyFaction
{
    public _AMD_Faction_getMyFaction(IceInternal.Incoming in)
    {
        super(in);
    }
