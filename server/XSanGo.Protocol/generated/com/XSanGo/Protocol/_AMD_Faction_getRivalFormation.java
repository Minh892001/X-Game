...
final class _AMD_Faction_getRivalFormation extends IceInternal.IncomingAsync implements AMD_Faction_getRivalFormation
{
    public _AMD_Faction_getRivalFormation(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(GvgChallengeView __ret)
    {
