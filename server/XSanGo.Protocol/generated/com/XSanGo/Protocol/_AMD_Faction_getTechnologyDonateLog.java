...
final class _AMD_Faction_getTechnologyDonateLog extends IceInternal.IncomingAsync implements AMD_Faction_getTechnologyDonateLog
{
    public _AMD_Faction_getTechnologyDonateLog(IceInternal.Incoming in)
    {
        super(in);
    }
