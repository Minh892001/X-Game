...
final class _AMD_FriendsRecall_randomOfflineRole extends IceInternal.IncomingAsync implements AMD_FriendsRecall_randomOfflineRole
{
    public _AMD_FriendsRecall_randomOfflineRole(IceInternal.Incoming in)
    {
        super(in);
    }
