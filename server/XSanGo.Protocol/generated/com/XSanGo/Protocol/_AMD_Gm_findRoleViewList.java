...
final class _AMD_Gm_findRoleViewList extends IceInternal.IncomingAsync implements AMD_Gm_findRoleViewList
{
    public _AMD_Gm_findRoleViewList(IceInternal.Incoming in)
    {
        super(in);
    }
