...
final class _AMD_Gm_getFactionList extends IceInternal.IncomingAsync implements AMD_Gm_getFactionList
{
    public _AMD_Gm_getFactionList(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(GmFactionView[] __ret)
    {
