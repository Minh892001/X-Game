...
final class _AMD_Gm_getFactionMemberList extends IceInternal.IncomingAsync implements AMD_Gm_getFactionMemberList
{
    public _AMD_Gm_getFactionMemberList(IceInternal.Incoming in)
    {
        super(in);
    }
