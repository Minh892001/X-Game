...
final class _AMD_Gm_getPlayerSkillConfig extends IceInternal.IncomingAsync implements AMD_Gm_getPlayerSkillConfig
{
    public _AMD_Gm_getPlayerSkillConfig(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(IntString[] __ret)
    {
