...
final class _AMD_Haoqingbao_myRedPacket extends IceInternal.IncomingAsync implements AMD_Haoqingbao_myRedPacket
{
    public _AMD_Haoqingbao_myRedPacket(IceInternal.Incoming in)
    {
        super(in);
    }
