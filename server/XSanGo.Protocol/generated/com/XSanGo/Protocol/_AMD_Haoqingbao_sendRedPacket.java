...
final class _AMD_Haoqingbao_sendRedPacket extends IceInternal.IncomingAsync implements AMD_Haoqingbao_sendRedPacket
{
    public _AMD_Haoqingbao_sendRedPacket(IceInternal.Incoming in)
    {
        super(in);
    }
