...
final class _AMD_Ladder_autoFight extends IceInternal.IncomingAsync implements AMD_Ladder_autoFight
{
    public _AMD_Ladder_autoFight(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(LadderAutoFightResult __ret)
    {
