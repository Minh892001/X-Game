...
final class _AMD_Ladder_beginFight extends IceInternal.IncomingAsync implements AMD_Ladder_beginFight
{
    public _AMD_Ladder_beginFight(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(LadderPvpView __ret)
    {
