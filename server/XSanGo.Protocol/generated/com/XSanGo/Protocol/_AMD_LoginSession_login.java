...
final class _AMD_LoginSession_login extends IceInternal.IncomingAsync implements AMD_LoginSession_login
{
    public _AMD_LoginSession_login(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(ServerList __ret)
    {
