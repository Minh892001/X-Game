...
final class _AMD_Role_getRoleHeros extends IceInternal.IncomingAsync implements AMD_Role_getRoleHeros
{
    public _AMD_Role_getRoleHeros(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(OthersHeroView __ret)
    {
