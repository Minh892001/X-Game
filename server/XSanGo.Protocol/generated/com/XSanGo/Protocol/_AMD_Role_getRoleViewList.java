...
final class _AMD_Role_getRoleViewList extends IceInternal.IncomingAsync implements AMD_Role_getRoleViewList
{
    public _AMD_Role_getRoleViewList(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(RoleView[] __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                RoleViewSeqHelper.write(__os, __ret);
