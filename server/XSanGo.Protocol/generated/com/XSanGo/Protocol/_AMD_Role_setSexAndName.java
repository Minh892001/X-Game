...
final class _AMD_Role_setSexAndName extends IceInternal.IncomingAsync implements AMD_Role_setSexAndName
{
    public _AMD_Role_setSexAndName(IceInternal.Incoming in)
    {
        super(in);
    }
