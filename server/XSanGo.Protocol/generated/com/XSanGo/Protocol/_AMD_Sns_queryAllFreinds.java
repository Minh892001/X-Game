...
final class _AMD_Sns_queryAllFreinds extends IceInternal.IncomingAsync implements AMD_Sns_queryAllFreinds
{
    public _AMD_Sns_queryAllFreinds(IceInternal.Incoming in)
    {
        super(in);
    }
