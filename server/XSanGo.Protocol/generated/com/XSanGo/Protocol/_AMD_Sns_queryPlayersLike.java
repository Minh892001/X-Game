...
final class _AMD_Sns_queryPlayersLike extends IceInternal.IncomingAsync implements AMD_Sns_queryPlayersLike
{
    public _AMD_Sns_queryPlayersLike(IceInternal.Incoming in)
    {
        super(in);
    }
