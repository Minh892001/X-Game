...
final class _AMD_Tournament_beginFightWith extends IceInternal.IncomingAsync implements AMD_Tournament_beginFightWith
{
    public _AMD_Tournament_beginFightWith(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(FightFormations __ret)
    {
