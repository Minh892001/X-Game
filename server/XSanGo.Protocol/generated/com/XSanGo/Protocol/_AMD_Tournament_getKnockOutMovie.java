...
final class _AMD_Tournament_getKnockOutMovie extends IceInternal.IncomingAsync implements AMD_Tournament_getKnockOutMovie
{
    public _AMD_Tournament_getKnockOutMovie(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(CrossMovieView __ret)
    {
