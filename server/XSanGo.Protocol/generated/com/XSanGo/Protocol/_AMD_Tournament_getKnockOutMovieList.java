...
final class _AMD_Tournament_getKnockOutMovieList extends IceInternal.IncomingAsync implements AMD_Tournament_getKnockOutMovieList
{
    public _AMD_Tournament_getKnockOutMovieList(IceInternal.Incoming in)
    {
        super(in);
    }
