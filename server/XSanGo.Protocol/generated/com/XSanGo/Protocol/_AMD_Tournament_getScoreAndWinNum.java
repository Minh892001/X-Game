...
final class _AMD_Tournament_getScoreAndWinNum extends IceInternal.IncomingAsync implements AMD_Tournament_getScoreAndWinNum
{
    public _AMD_Tournament_getScoreAndWinNum(IceInternal.Incoming in)
    {
        super(in);
    }
